...
<style>
    ...
    .toggle-side::before, .toggle-side > .vericaltext{
        color:#FF7900;
    ...
    .scroll > form > input:focus, .scroll > form > textarea:focus{
        border:1px solid #FF7900;
    }
    .scroll > form > .btn-1{
...
<div id="slider" class="slideshow-container">
    <img class="d-none d-sm-block" src="./assets/img/pharmacy/pharmacy.jpeg" style="width:100%">
