                ...
                <div class="col-12 col-md-10 mt-3 mt-sm-0 pt-5 ">
                    <div class="">
                        ...
                        <h1 class="tmu-text-primary tmu-page-heading" id="overall"><span>Internal Quality </span> <span> Assurance Cell (IQAC) </span></h1>
                            <h3 class="tmu-text-primary mb-2 mt-2"><span>Minutes of Meeting </span><span>of IQAC</span></h3>
                            <div class="row">
                            <div class="col-md-3 mb-3">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <!-- Document Name -->
                                            <h5 class="card-title">Minutes of the Meeting of the IQAC held on December 10, 2022</h5>
                                            <!-- View PDF Button -->
                                            <a href="https://www.tmu.ac.in/pdf/iqac_minutes/coe/2nd_IQAC_MoM_10_Dec_2022.pdf" class="more-link fst-normal ms-2 fs-14 font-poppins">View pdf <i class="bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
