...
.text {
  ...
  <img class="d-none d-sm-block" src="demos/saas-2/images/101.jpg" style="width:100%">
  <div class="text d-none d-sm-block" style="color: #000000;">
  <h1>Build Powerful Websites in a flash.</h1>
  <p >Transforming Your Ideas into Stunning Websites with Intuitive Tools and Limitless Possibilities.</p>
                        <a class="my-button" style="">Download Brocher</a>
                        <a class="my-button-blk">Apply Now</a>
</div>
<div class="img-right d-none d-sm-block">
