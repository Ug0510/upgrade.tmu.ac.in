        ...
        <div class="row justify-content-center gutter-30 col-mb-5">
            ...
            <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
              ...
              <div class="team-desc p-2">
                <div class="team-title pt-0">
                  <h4>Rain Water Harvesting System</h4><span class="fst-normal" style="font-size:16px; font-family:'poppins';"><i class="fa-solid fa-location-dot"></i> TMU Campus</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
              ...
              <div class="team-desc p-2">
                <div class="team-title pt-0">
                  <h4>Rain Water Harvesting System</h4><span class="fst-normal" style="font-size:16px; font-family:'poppins';"><i class="fa-solid fa-location-dot"></i> TMU
                    Campus</span>
                </div>
              </div>
            </div>
