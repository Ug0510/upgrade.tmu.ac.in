                    ...
                    <div class="row mx-0">
                        <h1 class="tmu-text-primary tmu-page-heading"><span>About Research </span><span class="d-block d-sm-inline"> & Development Center</span></h2>
                            ...
                            <ol class="ps-5 m-ol-list">
                                ...
                                <li>Share the latest knowledge with students, researchers, faculty members, the scientific community, media, and the general public.</li>
                                <li>Train undergraduate students, graduate students, researchers, PhD students, post-doctoral fellows, school teachers, and faculty members to become world-class experts through research activities.</li>
                                <li>Serve as a hub to create technological synergies with faculty members and experts worldwide.</li>
                                <li>Provide open research lab and workshop facilities for retired professors, scientists, and engineers.</li>
                                <li>Establish Memoranda of Understanding (MOUs) with national and international universities, research laboratories, and industries.</li>
                                <li>Develop student exchange programs.</li>
                                <li>Promote opportunities for women researchers to access national and international scholarships and schemes.</li>
