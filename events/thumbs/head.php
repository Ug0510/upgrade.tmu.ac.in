...
<head>
    ...
    -webkit-text-stroke: 2px #001055; /* Webkit browsers */
    color: #000;
    font-size: 24px;
    text-align: center;
    z-index: 1;
            ...
            <nav id="main--menubar">
                ...
                <div class="right-section">
                    ...
                    <div id="menubar__content">
                        ...
                        <div id="nav-banner">
                            <img src="https://www.hindustantimes.com/ht-img/img/2023/08/08/550x309/Screenshot_2023-08-08_183058_1691499721701_1691499729400.png"
                                class="w-100" alt="">
                ...
                if (categoryList[value] && typeof categoryList[value] === 'object') {
                    ...
                    for (const itemName in category) {
                        if (!category[itemName].link) {
                            htmlContent +=
                                `<li class="underline__effect" onclick="openSubMenuContent('${value}','${itemName}',this)">${itemName}</li>`;
                        } else {
                            htmlContent +=
        ...
        async function openSubMenuContentMobile(value, menu) {
            ...
            try {
                ...
                for (let item in catalogue[value][menu]) {
                    if (catalogue[value][menu][item].link) {
                        htmlContent +=
                            `<li><a href="${catalogue[value][menu][item].link}" class="additional-link">${item}</a><i class="fa-solid fa-caret-right"></i></li>`;
                    } else {
                        htmlContent +=
                ...
                if (categoryList[value] && typeof categoryList[value] === 'object') {
                    ...
                    for (const itemName in category) {
                        if (!category[itemName].link) {
                            ...
                            htmlContent +=
                                `<li><a href="${category[itemName].link}" class="additional-link">${itemName}</a><i class="fa-solid fa-caret-right"></i></li>`;
                        }
                    }
                }
