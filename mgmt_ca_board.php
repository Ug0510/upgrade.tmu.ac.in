        ...
        <div class="container-fluid my-0 px-0">
            <div class="row">
                ...
                <div class="col-12 col-sm-9 col-lg-10 mt-3 mt-sm-0 pt-2 pt-sm-5">
                    ...
                    <div class="container">
                        <div class="row">
                            <p class="text-justify mb-3">For any professional institution the interaction with academic and corporate world is of
                        ...
                        <div class="row">
                            ...
                            <hr class="horizontal-line">
                            <button class="careers-accordion"> Committee Members of Industry Linkages<span
                                    class="icon">+</span>
                            </button>
                            <div class="panel">
                                <div class="table-responsive">
