...
<div class="col-12 col-md-9 col-lg-9 mt-3 mt-sm-0 pt-5">
    ...
    <div class="container">
        <div class="row">
            <p>For any professional institution the interaction with academic and corporate world is of great
                importance. College has Corporate Advisory Board including Principal (as Chair Person), Head Training &
                Placement and members from the industries. The Board members provides advice and guidance on academic
                program to the college as a whole or to individual academic departments. This helps ensure our curricula
                remain relevant and rigorous. Corporate Advisory Board members also interact with faculty & Students
            ...
            <div class="row">
                ...
                <div class="panel active">
                    <ul class="m-ol-list ps-2 mt-2">
                        ...
                        <li>Developing entrepreneurial abilities, by providing projects that engage students in
                            ‘design to delivery solution’ to improve the quality.</li>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-condensed mb-none">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5"><b>Note:</b> All course coordinators are the default members of this
                                        committee.</td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <hr class="horizontal-line">
                <button class="careers-accordion"> Committee Members of Industry Linkages<span class="icon">+</span>
                </button>
                <div class="panel">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-condensed mb-none">
