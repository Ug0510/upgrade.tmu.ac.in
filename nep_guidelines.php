...
?>
				...
				<div class="col-12 col-md-9 col-lg-9 mt-3 mt-sm-0 pt-5 ">
                    ...
                    <div class="container">
                       ...
                       <center><a type="button" class="button button-mini mb-3 text-left" style="background-color:#FF7A00;" href="https://www.tmu.ac.in/pdf/nep_cell_2020/guidelines/Guidelines1.pdf" 
                       download type="application/pdf"><i class="bi-download" aria-hidden="true"></i>Click here to download PDF file.</a></center>        
                    </div>
                    </div>
            </div>
        </div>
