                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">B.P.Ed. (Bachelor of Physical Education)</h4>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">B.P.E.S. (Bachelor of Physical Education & Sports)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">B.P.E.S with Research(Physical Education)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">M.P.Ed. (Master of Physical Education)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
