...
<section id="content">
    <div class="content-wrap py-0">
        <div class="container-fluid my-0 px-0">
            <div class="row">
                <?php include 'sidebar/open_elective_sidebar.php'; ?>
                                ...
                                <table id="datatable1" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><a
                                                    href="https://www.tmu.ac.in/uploads/announcement/Circulars_R_O__2022-23_0151.pdf"><i class="fa-solid fa-file-pdf"></i></a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
