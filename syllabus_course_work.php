                ...
                <div class="col-12 col-md-10 mt-3 mt-sm-0 pt-5 ">
                    ...
                    <div class="row mx-0">
                        ...
                        <div>
                            ...
                            <p class="mb-3"><b>* Amended w.e.f. January 01, 2020, as per UGC <a
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <p class="text-center mb-2 mt-3 fw-bold">EVALUATION OF REVIEW OF LITERATURE
                                        (RMGT171)</b></p>
                                    <p class="mb-1 mt-3">The research scholar shall submit a draft copy of the review of
                                        literature duly recommended by his supervisor(s) to the concerned
                        ...
                        <h3 class="mb-2 pb-0 tmu-text-primary"><span>Syllabus for Coursework (Research Methodology)
                            </span><span> COURSE CODE: RRMD101</span></h3>
                        ...
                        <h3 class="mb-2 pb-0 tmu-text-primary"><span>Syllabus for Coursework (Quantitative Methods and Computer
                        ...
                        <h3 class="mb-2 pb-0 tmu-text-primary"><span>Review of Literature </span><span>COURSE CODE: RMGT171</span></h3>
                        <hr class="horizontal-line">
                        <button class="careers-accordion">Objective <span class="icon">+</span></button>
                        <div class="panel">
                        ...
                        <h3 class="mb-2 pb-0 tmu-text-primary"><span>Research and Publication Ethics (RPE) </span><span> COURSE CODE: CPE-RPE101</span>
                        </h3>
                        <hr class="horizontal-line">
                        <button class="careers-accordion">Objective <span class="icon">+</span></button>
                        <div class="panel">
                        ...
                        <h3 class="mb-2 pb-0 tmu-text-primary"><span>Coursework for Ph.D. </span><span>Programme in Nursing</span></h3>
                        ...
                        <p><span style="color:#E74C3C; font-weight:bold; fotn-size: 20px;">Note:</span> 70% attendance
                        ...
                        <object data="https://www.tmu.ac.in/pdf/research/nursing_syllabus.pdf" type="application/pdf"
                            ...
                            <center><a type="button"
                                    ...
                                    href="https://www.tmu.ac.in/pdf/research/nursing_syllabus.pdf" download=""
                        ...
                        <hr>
                        <p class="mb-3"><b>The details of the above courses can be accessed on the following link of INDIAN NURSING
                            COUNCIL NOTIFICATION New Delhi, the 6th November, 2020.</b></p>
                        <!-- container ends -->
                    </div>
                </div>
            </div>
