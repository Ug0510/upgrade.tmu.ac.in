...
<style>
    .swiper-slide--one {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/1st.png") no-repeat 50% 50% / contain;
    }

    .swiper-slide--two {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/2nd.png") no-repeat 50% 50% / contain;
    }

    .swiper-slide--three {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/3rd.png") no-repeat 50% 50% / contain;
    }

    .swiper-slide--four {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/4th.png") no-repeat 50% 50% / contain;
    }

    .swiper-slide--five {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/5th.png") no-repeat 50% 50% / contain;
    }

    .swiper-slide--six {
        background: linear-gradient(to top, #ffffff00, #203a4300, #2c536400),
            url("./assets/image/certification/6th.png") no-repeat 50% 50% / contain;
    }
...
<style>
    ...
    .tmu-modal .tmu-modal-box .close-btn {
        position: absolute;
        top: 5px;
        right: 15px;
        font-size: 1.6rem;
    ...
    #collabModal .tmu-modal-box .custom-card-text {
        max-height: 50vh;
        overflow-y: auto;
    }

    #testimonialModal .tmu-testimonial {
        border-radius: 10px;
    }

    #testimonialModal .tmu-testimonial .testimonial>p:nth-child(2) {
        max-height: 50vh;
        overflow: auto;
        text-align: justify;
    }

    #testimonialModal .tmu-testimonial .testimonial {
        /* padding-bottom: 2rem; */
        overflow: hidden;
        padding: 0 1rem;
        padding-right: 1rem;
    ...
    #testimonialModal .tmu-testimonial .testimonial:before {
        /* padding-bottom: 2rem; */
        display: none;
    }

    #testimonialModal .tmu-testimonial .overview {
        margin-left: 0;
    }
...
<style>
    ...
    .tmimt-awards-heading>span:first-child {
        color: white;
        font-size: 3rem;
        float: left;
    }
