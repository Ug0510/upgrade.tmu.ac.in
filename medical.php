...
<div id="slider" class="slider-element min-vh-0">
  ...
  <div class="row justify-content-center">
	...
	<div class="box">
		<h2 Class="h2-line" style="font-weight: 800;">Welcome to the TMMC&RC</h2>
		<div class="row">
		    <div class="col-md-1"></div>
			<div class="col-md-10 col-sm-10" >
				<p style="text-align: justify;">Teerthanker Mahaveer Medical College & Research Centre was established in year 2008 with the approval of the Ministry of Health and Family Welfare for an admission intake of 100 MBBS students, which has been increased to 150 from the Academic Session 2014-15.<br>
