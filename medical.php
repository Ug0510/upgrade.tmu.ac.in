    ...
    <ul class="nav nav-tabs justify-content-center py-2 gap-2 gap-md-5" id="myTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#Tab1" type="button"
                role="tab" aria-controls="Tab1" aria-selected="true"><i class="fas fa-lightbulb"></i> Approved by
                MCI</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab2-tab" data-bs-toggle="tab" data-bs-target="#Tab2" type="button" role="tab"
                aria-controls="Tab2" aria-selected="false"><i class="fas fa-briefcase"></i>
                Hospital
                Facilities</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#Tab3" type="button" role="tab"
                aria-controls="Tab3" aria-selected="false"><i class="fas fa-book"></i> General
                Surgery</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab4-tab" data-bs-toggle="tab" data-bs-target="#Tab4" type="button" role="tab"
                aria-controls="Tab4" aria-selected="false"><i class="fas fa-building"></i>
                Rediology</button>
        </li>
    </ul>
...
<div class="section bg-transparent mt-0" style="margin-bottom:30px;">
    ...
    <div class="owl-carousel owl-carousel-full image-carousel carousel-widget charity-card" data-stage-padding="20"
        data-margin="10" data-center="true" data-loop="true" data-nav="true" data-autoplay="2000" data-speed="400"
        data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="4">
                ...
                <div class="col-md-3">
                    <div class="list-group" id="list-tab" role="tablist">
                        ...
                        <a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2"
                            ...
                            aria-controls="list-profile"><i class="fa-solid fa-microchip fa-sm fakash"></i>&nbsp;PG
                            Programmes
        ...
        <div class="container mb-5 mt-5">
            ...
            <div class="panel">
                <ul class="progul">
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/9.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/13.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/16.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/19.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/1.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/34.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/25.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/21.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/3.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
                    ...
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/5.jpg" class="card-img-top" alt="...">
                            <div class="card-body progcardbody">
            ...
            <div class="panel">
                <ul class="progul">
                    <li class="progli">
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/19.jpg" height="178px" class="card-img-top"
                    ...
                    <li class="progli">
                        ...
                        <div class="card shadow-sm progcard">
                            <img src="assets/img/programme_stock_img/medical/33.jpg" height="178px" class="card-img-top"
                                alt="...">
                            <div class="card-body progcardbody">
                                            ...
                                            <div class="fslider" data-arrows="false" data-lightbox="gallery">
                                                <div class="flexslider">
                                                    <div class="slider-wrap">
                                                        <div class="slide"><a href="images/news/ccsit/News_05.jpg"
                                    ...
                                    <div class="grid-inner shadow-sm card newsheight" style="height: 300px;">
                                        <div class="entry-image mb-0">
                                            <div class="fslider" data-arrows="false" data-lightbox="gallery">
                                                <div class="flexslider">
                                                    <div class="slider-wrap">
                                                        <div class="slide"><a href="images/news/ccsit/News_04.jpg"
                                                                data-lightbox="gallery-item"
                                    ...
                                    <div class="grid-inner shadow-sm card newsheight" style="height: 300px;">
                                        <div class="entry-image mb-0">
                                            <div class="fslider" data-arrows="false" data-lightbox="gallery">
                                                <div class="flexslider">
                                                    <div class="slider-wrap">
                                                        <div class="slide"><a href="images/news/ccsit/News_01.jpg"
                                                                data-lightbox="gallery-item"
                                        ...
                                        <div class="p-2">
                                            <div class="entry-title">
                                                <a herf="" style="font-size: 18px; font-weight: 500; ">CTLD's
                                                    Faculty
                        ...
                        <div class="notice-body">
                            ...
                            <div class="notice">
                                ...
                                <div class="notice-meta">
                                    <span style="margin-right: 15px;"><img src="assets/img/icons/placeholder.svg"
                                            width="20px" height="20px">
                                        Conference Room</span>
                                    <span><img src="assets/img/icons/calendar.svg" width="20px" height="20px">
                                        09,
                                        March</span>
                                </div>
                            </div>
...
<section>
    <div class="container-xl tmu-testimonial mt-5 mb-3">
        ...
        <div class="owl-carousel owl-carousel-full image-carousel carousel-widget charity-card"
            style="overflow: visible;" data-stage-padding="20" data-margin="50" data-center="true" data-loop="true"
            data-nav="true" data-autoplay="200000" data-speed="2000" data-pagi="true" data-items-xs="1"
            data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="3">

            <div class="oc-item text-start">
                <div class="media ">
                    <img src="https://www.tmu.ac.in/monaco/assets/image/testimonials/rashmi_raj_bcom.webp" class="mr-3"
                        alt="">
            ...
            <div class="oc-item text-start">
                <div class="media">
                    <img src="https://www.tmu.ac.in/monaco/assets/image/testimonials/pragati_law.webp" class="mr-3"
                        alt="">
                    <div class="media-body">
                        <div class="testimonial">
            ...
            <div class="oc-item text-start">
                <div class="media">
                    <img src="https://www.tmu.ac.in/monaco/assets/image/testimonials/shaily_jain_mca.webp" class="mr-3"
                        alt="">
                    <div class="media-body">
                        <div class="testimonial">
            ...
            <div class="oc-item text-start">
                <div class="media">
                    <img src="https://www.tmu.ac.in/monaco/assets/image/testimonials/nikita_shah_bcom.webp" class="mr-3"
                        alt="">
                    <div class="media-body">
                        <div class="testimonial">
...
<div id="testimonialModal" class="tmu-modal">
    ...
    <div class="tmu-modal-box">
        ...
        <div class="tmu-testimonial bg-light">
            <div class="media">
                <img src="https://www.tmu.ac.in/monaco/assets/image/testimonials/abdul_india_mart_mba.webp" class="mr-3"
                    alt="">
                <div class="media-body">
                    <div class="testimonial">
