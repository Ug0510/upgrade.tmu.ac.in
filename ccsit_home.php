				...
				<div class="container-fluid p-0">
					<div class="video-banner">
						<video autoplay loop muted playsinline>
							<source src="assets/img/banner/111.jpg" type="video/mp4">
...
<br>
       <!-----Upper card start-->
		...
		<section id="content" style="margin-top: 1rem;">
									...
									<div class="card l-bg-cherry">
										<div class="card-statistic-3 p-4">
											...
											<div class="mb-4">
												...
												<div class="card-text" style="font-size: 19px;">Visited Companies</div>
											</div>
									...
									<div class="card l-bg-blue-dark">
										<div class="card-statistic-3 p-4">
											...
											<div class="mb-4">
												...
												<div class="card-text" style="font-size: 19px;">Placement in 2022-23</div>
											</div>
											<!-- <div class="row align-items-center mb-2 d-flex">
										<div class="col-8">
											<h2 class="d-flex align-items-center mb-0">
									...
									<div class="card l-bg-green-dark">
										<div class="card-statistic-3 p-4">
											...
											<div class="mb-4">
												...
												<div class="card-text" style="font-size: 19px;">Highest Placement</div>
											</div>
											<!-- <div class="row align-items-center mb-2 d-flex">
										<div class="col-8">
											<h2 class="d-flex align-items-center mb-0">
									...
									<div class="card l-bg-orange-dark">
										<div class="card-statistic-3 p-4">
											...
											<div class="mb-4">
												...
												<div class="card-text" style="font-size: 19px;">World Wide Alumni</div>
											</div>
										</div>
									</div>
								</div>
...
<!-----Upper card start mobile-->
 ...
 <div class="container">
        <div class="mx-auto text-center mt-4 mb-5 heading-block" style="max-width: 960px;">
            <h5 class="text-uppercase ls-1 text-muted mb-3" style="margin-top: -3rem; ;">About Us</h5>
            <h2 class="text-transform-none mb-4">Welcome to the College of Computing Sciences & IT</h2>
            <p class="lead fw-normal font-primary mb-5">The College of Computing Sciences & IT established in 2014 (formerly known as the Department of Computer Applications, established in 2001),is a leading private computing sciences college in UP. <br>With a strong emphasis on emerging technologies such as Artificial Intelligence (AI), Machine Learning (ML), and Deep Learning (DL), the college equips students with the in-demand skills to thrive in the rapidly evolving IT industry. 
               Beyond technical expertise, the CCS&IT also fosters an entrepreneurial mindset, nurturing the next generation of innovators and visionaries. <br>
               <a href="#" class="button button-3d button-medium button rounded-pill button-blue">Know More!</a>
            </p>
        </div>
    </div>
<!-- About section Ends here  -->
                        ...
                        <div class="owl-carousel" id="owl-carousel4">
                            <div class="item">
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket1" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/1.svg"
                            ...
                            <div class="item">
                                ...
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket2" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/2.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                            ...
                            <div class="item">
                                ...
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket3" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/3.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                            ...
                            <div class="item">
                                ...
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket4" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/4.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                            ...
                            <div class="item">
                                ...
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket5" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/5.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                            ...
                            <div class="item">
                                ...
                                <div class="card shadow-sm ">
                                    ...
                                    <a href="#block-modal-ticket5" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/3.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                            ...
                            <div class="item">
                                ...
                                <iframe width="1424" height="652" src="https://www.youtube.com/embed/tEkfa3bIY5o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    ...
                                    <a href="#block-modal-ticket5" data-lightbox="inline"><img src="https://new.tmu.ac.in/video-testimonial/1.svg"
                                            class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                                        <span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
                                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
        ...
        <section id="content">
            <div class="content-wrap py-0 bg-dark">
                <main1>
                    <div class="d-none d-sm-block" style="margin-top: -5rem;">
						<h2>Tech-</h2>
...
<br>
		...
		<section id="content" style="margin-top: 40px;">
			<div class="content-wrap py-0">
				...
				<div class="col-xl-12 col-lg-10 text-center">
					<h3 class="h1 fw-bold mb-3">Discover Your Future with Our Program Finder</h3>
				</div>
							...
							<div class="list-group" id="list-tab" role="tablist">
								<a class="pgroup list-group-item listream list-group-item-action rounded-3 shadow-sm active"
									...
									aria-controls="list-home"><i
										class="fa-solid fa-graduation-cap fa-sm fakash"></i>&nbsp;UnderGraduate
									&nbsp;&nbsp;<span class="badge rounded-pill">05</span>
								</a>
								<a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2"
									...
									aria-controls="list-profile"><i
										class="fa-solid fa-briefcase fa-sm fakash"></i>&nbsp;Postgraduate
									&nbsp;&nbsp;<span class="badge rounded-pill">02</span></a>
								<a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2"
								...
								<!-- <a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2"
									...
									aria-controls="list-settings"><i class="fa-solid fa-diploma fa-sm fakash"></i>&nbsp;Diploma 
									&nbsp;&nbsp;<span class="badge rounded-pill">08</span></a> -->
							</div>
						</div>
						<div class="col-md-9">
									...
									<div class="row">
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm ">
												...
												<div class="card-body">
													...
													<h4 class="mb-2">BCA (Bachelor of Computer Applications)</h4>
												</div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body">
													<span
														class="badge bg-info11 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">B.Sc. (Computer Sciences Honors)
													</h4>
												</div>
												<div
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">B.Sc. (Animation)</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
													<div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">B.Tech. (Computer Sciences and Engineering)</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
													<div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">B.Sc. (Cognitive Science)</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
													<div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">M.Tech. (Computer Sciences and Engineering)</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
													<div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">MCA (Master of Computer Applications) 
													</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">Ph.D. Computer Applications</h4>
												</div>
												<div
													class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
													<div>
										...
										<div class="col-md-4">
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">Ph.D. Computer Science Engineering</h4>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="panelsStayOpen-headingOne">
								<button class="accordion-button" type="button" data-bs-toggle="collapse"
									...
									<i class="fa-solid fa-computer fa-sm fakash"></i>&nbsp;&nbsp;UnderGraduate
								</button>
							</h2>
										...
										<li class="progli">
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h5 class="mb-2">B.Tech. (Computer Sciences and Engineering)</h5>
										...
										<li class="progli">
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">BCA (Bachelor of Computer Applications)
													</h4>
										...
										<li class="progli">
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">B.Sc. (Computer Sciences Honors)</h4>
													<!-- <p class="mb-4 op-07" style="line-height: 1.65">Secure your future
														with our B.Tech in Computer Science, specializing in
														Cybersecurity. Join us to become a guardian of digital realms.
													</p> -->
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="panelsStayOpen-headingTwo">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
									...
									<i class="fa-solid fa-microchip fa-sm fakash"></i>&nbsp;&nbsp;PostGraduate</button>
							</h2>
										...
										<li class="progli">
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">MCA (Master of Computer Applications)</h4>
										...
										<li class="progli">
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">M.Tech. (Computer Sciences and Engineering)
													</h4>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="panelsStayOpen-headingThree">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
									...
									<i
										class="fa-solid fa-business-time fa-sm fakash"></i>&nbsp;&nbsp;Doctorate</button>
							</h2>
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">Ph.D. Computer Science Engineering</h4>
													<!-- <p class="mb-4 op-07" style="line-height: 1.65">"Our BBA in International Business & Entrepreneurship nurtures 
														global business mindset and entrepreneurial spirit, 
														fostering skills to thrive in diverse markets and create innovative ventures."
													</p> -->
													<!-- <small class="ls-2 fw-bold text-uppercase op-05 mb-2 d-block">Features</small> -->
													<!-- <div class="row g-0 mb-2 car-features">
														<div class="col-6 mb-2"><i class="icon-car-meter"></i>20000KMs</div>
											...
											<div class="card shadow-sm progcard">
												...
												<div class="card-body progcardbody">
													<span
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
													<h4 class="mb-2">Ph.D. Computer Applications</h4>
													<!-- <p class="mb-4 op-07" style="line-height: 1.65">"Our BBA in HR, Marketing, and Finance cultivates 
														versatile professionals with expertise in human resources, strategic marketing,
														 and financial management, poised for dynamic business leadership."
													</p> -->
													<!-- <small class="ls-2 fw-bold text-uppercase op-05 mb-2 d-block">Features</small>
														<div class="row g-0 mb-2 car-features">
															<div class="col-6 mb-2"><i class="icon-car-meter"></i>20000KMs</div>
        ...
        <div class="row justify-content-center"  style="margin-top: -3rem;">
            <div class="col-xl-9 text-center">
                <h3 class="h1 fw-bold text-dark mb-3">Industry Collaborations</h3>
            </div>
        </div>
            ...
            <div class="real-estate owl-carousel image-carousel carousel-widget mb-6" data-margin="10" data-nav="true" data-loop="true" data-pagi="false" data-items-xs="1" data-items-sm="1" data-items-md="2" data-items-lg="3" data-items-xl="3">
                ...
                <div class="oc-item">
                    <div class="real-estate-item">
                        <div class="real-estate-item-image">
                            <a href="#">
                                <img src="images/iNurture.jpg" alt="Image 1">
                            </a>
                        </div>
                ...
                <div class="oc-item">
                    <div class="real-estate-item">
                        <div class="real-estate-item-image">
                            <a href="#">
                                <img src="images/IBM _IC.jpg" alt="Image 2">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="oc-item">
                    <div class="real-estate-item">
                        <div class="real-estate-item-image">
                            <a href="#">
                                <img src="images/TCS_ion.jpg" alt="Image 3">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center gy-5" style="--bs-gutter-x: 60px">
                    <div class="col-lg-12 mt-lg-6">                                        
                        <div class="heading-block text-center mx-auto" style="max-width: 1200px; text-align: left;">
                            <h2 class="mb-2 text-transform-none ls-0"><span style="color: #ff6803;">CCSIT</span> Frequently Asked Questions</h2>
                        </div>
                        <div class="px-lg-6 p-5 rounded"
                            ...
                            <div class="toggle toggle-lg py-4 border-bottom mb-0">
                                <div class="toggle-header align-items-center">
                                    ...
                                    <div class="toggle-title fw-semibold">
										What Are the Key Highlights of the college?
                                    </div>
                                    <div class="toggle-icon">
                                ...
                                <div class="toggle-content fs-6">Introducing an innovative wind turbine developed by Mr Pradeep Kumar Gupta, our Assistant Professor. This turbine harnesses the power of wind generated by vehicles on highways, converting it into renewable electric power.
									By placing these turbines on highway dividers, they utilise the air movements created by passing vehicles. These air movements drive the rotation of the turbines, generating electricity in the process. The generated electricity is efficiently stored in a battery connected to the turbine via a regulator circuit and converter. When multiple units are installed together, substantial electric power can be produced.
									This innovative solution has far-reaching applications. It can be employed to power streetlight indicators, illuminate roads and enhance safety measures. By reducing accidents, we will be closer to a safer and more sustainable transportation system.
									With these groundbreaking developments and many more, TMU showcases the immense potential of academic ingenuity in addressing real-world challenges effectively and innovatively.
                                </div>
                            </div>
                            ...
                            <div class="toggle toggle-lg py-4 border-bottom mb-0">
                                ...
                                <div class="toggle-content fs-6">As a centre for computing sciences, CCS&IT offers a pool of internships and placement opportunities for a swift transition from academics to the professional world.
									<ul><li>Our training & placement cell (CRC) is committed to generating top-notch placement and training opportunities.</li>
										<li>Reputed industrial giants like HCL, Infosys, Wipro, Vivo, TCS, Tech Mahindra, and more visit our campus for recruitment drives.</li>
										<li>With a focus on ensuring 82% placement and securing the best jobs, our CRC and CTLD departments prepare students from the beginning.</li></ul>
								</div>
                            </div>
                            ...
                            <div class="toggle toggle-lg py-4 border-bottom mb-0">
                                ...
                                <div class="toggle-content fs-6">The CCS&IT’s curriculum is designed to equip students with updated knowledge and technical skills. Our faculties use effective pedagogy, fostering an optimal learning environment. We value students’ participation in conferences, seminars, workshops, and group discussions for overall development. We also offer short-term courses to expand their skill set. Expert guest lectures and collaborations with industry leaders enhance our students' learning. Our curriculum aligns with NEP2020, preparing students for success in technology. 
									The College of computing sciences & IT is a leading computing science college that ignites the spark of innovation in every student.</div>
                            </div>

                            <div class="toggle toggle-lg py-4 mb-0">
                                <div class="toggle-header align-items-center">
                                    <div class="toggle-title fw-semibold">
										What is the state of our college's infrastructure facilities today?
                                    </div>
                                    <div class="toggle-icon">
                                        <i class="toggle-closed bi bi-plus-circle fs-4 op-05"></i>
                                        <i class="toggle-open bi bi-dash-circle fs-4"></i>
                                ...
                                <div class="toggle-content fs-6">CCS&IT provides a conducive environment to provide quality education and support to both students and faculty members. The college boasts

									<ul><li>19 well-equipped labs with a total of 950 computers and peripherals, including a dedicated iMac Lab with 30 Apple Desktop PCs for the Apple Authorized Training Centre.</li>
									<li>Specialised labs such as Cisco Networking Lab, Linux Lab, Advanced Database Lab, Dot Net Lab, Android Lab, JAVA Lab, and IBM Cloud Software Lab for Emerging Technologies.</li>
								<li>World-class infrastructure featuring spacious lecture halls, a lecture theatre, a well-equipped library, and a seminar hall, all equipped with advanced facilities.</li>
								 <li>NVIDIA lab to enhance student skills in graphics and visualization.</li>
								<li>Spoken Tutorials by IIT-Bombay for assessing and enhancing student skills.</li></ul></div>
                            </div>
                        </div>
                    </div>
                </div>
