        ...
        <div class="col-12 col-md-9 mt-3 mt-sm-0 pt-5">
          ...
          <div class="row mx-0">
            <h2 class=" text-center" style="color:#001055;
                          text-transform: capitalize;
                          font-weight:700!important; font-size:2.4vmax">Code of Conduct <span
                class="d-block d-sm-inline"> for Employee</span></h2>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <tr>
            ...
            <td class="centered-icon"><a href="https://www.tmu.ac.in/pdf/employee_code_of_conduct.pdf"><i
