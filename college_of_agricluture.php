                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="testimonial">
                                    ...
                                    <p>TMU College of Agricultural Sciences offers a student-centred curriculum complemented by experienced and supporting professors. The latest facilities enhance the learning experience. Pursue your agriculture career with confidence at TMU.</div>
                                <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                            </div>
                        </div>
                    </div>
