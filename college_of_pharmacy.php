                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm ">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">B.Pharm. (Bachelor of Pharmacy)</h4>
                                                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">Pharm.D. (Doctor in Pharmacy)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">Pharm.D. (Post Baccalaureate)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">M.Pharm. (Pharmacology)</h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm progcard">
                                                ...
                                                <div class="card-body progcardbody">
                                                    ...
                                                    <h4 class="mb-2">M.Pharm. (Pharmaceutics)
                                                    </h4>
                                                </div>
                                                <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                                    <div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">M.Pharm. (Pharmacognosy)</h4>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="mb-2">M.Pharm. (Pharmaceutical Analysis)</h4>
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        ...
                                        <div class="card-body progcardbody">
                                            ...
                                            <h5 class="mb-2">B. Pharma (Bachelor of Phramcy)</h5>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                            </div>
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        ...
                                        <div class="card-body progcardbody">
                                            ...
                                            <h4 class="mb-2">Pharm.D. (Post Baccalaureate)
                                            </h4>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        ...
                                        <div class="card-body progcardbody">
                                            ...
                                            <h4 class="mb-2">M.Pharm. (Pharmaceutics) </h4>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                            </div>
