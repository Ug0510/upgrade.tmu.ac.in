						...
						<div class="row col-mb-30">
							...
							<div class="col-lg-4 widget_links">
								<div class="widget">
									...
									<img style="width: 60%;" alt="Teertahnker mahaveer university logo with name" class="img-fluid" src="images/logo/logo-footer.png">
...
<script src="./assets/js/tmimt_menubar.js"></script>
