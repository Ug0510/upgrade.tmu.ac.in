          ...
          <div class="container mb-4">
            <div class="row">
              <object data="https://www.tmu.ac.in/pdf/pdf/TMIMT_23_24_TT.pdf" type="application/pdf" width="100%" height="1120px">
                ...
                <center><a type="button" class="tmu-btn btn-1 m-0 py-1 px-2 mb-3" href="https://www.tmu.ac.in/pdf/pdf/TMIMT_23_24_TT.pdf" download="" data-uw-pdf-br="2" data-uw-pdf-doc=""><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
              </object>
            </div>
          </div>
        </div>
