...
<footer id="footer" class="dark" style="background-color: #001055;">
			<div class="container">
				<!-- Footer Widgets
										============================================= -->
								...
								<div class="row col-mb-30">
									...
									<div class="col-lg-4 widget_links">
										<div class="widget">
											...
											<img style="width: 60%;" alt="Teertahnker mahaveer university logo with name" class="img-fluid"
	...
	<script>
        window.addEventListener('load', function () {
            ...
            setTimeout(function () {
				...
				// play banner video
				// const vidDiv = document.getElementById('banner-vid');
				// vidDiv.setAttribute('src', './poster/tmu_video.mp4');
