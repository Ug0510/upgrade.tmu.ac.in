            ...
            <div class="row">
                ...
                <div class="col-12 col-md-10 col-lg-10 mt-3 mt-sm-0 pt-5 ">
                    ...
                    <object data="https://www.tmu.ac.in/pdf/medical/foundation-medical.pdf" type="application/pdf" width="100%" height="1150px">
		                ...
		                <center><a type="button" class="btn btn-success btn-lg btn-rounded text-lg waves-effect waves-light" href="https://www.tmu.ac.in/pdf/medical/foundation-medical.pdf" download type="https://www.tmu.ac.in/pdf/medical/foundation-medical.pdf"><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
	                </object>
                </div>
            </div>
        </div>
