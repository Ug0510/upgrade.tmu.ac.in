...
@media screen and (max-width:480px) { 
    ...
    #main--menubar .additional-link {
        color: #ffffffbb;
        position: relative; /* Make sure the ::after element is positioned relative to this */
    }
	...
	<div id="wrapper">
					...
					<div class="col-12 col-md-auto">
						...
						<ul id="top-social">
							...
							<li><a href="#" class="h-bg-twitter"><span class="ts-icon"><i
											class="fa-brands fa-twitter"></i></span><span
										class="ts-text">Twitter</span></a></li>
							<li class="d-none d-sm-flex"><a href="#" class="h-bg-dribbble"><span class="ts-icon"><i
											class="fa-brands fa-dribbble"></i></span><span
							...
							<li class="d-none d-sm-flex"><a href="#" class="h-bg-pinterest"><span class="ts-icon"><i
											class="fa-brands fa-pinterest-p"></i></span><span
		...
		<script>
			...
			function closeMenubar()
			{
			 ...
			 async function showSubCategories(value) {
				...
				try {
					...
					const response = await fetch('crcMenubarData.json');
			...
			function resetMainMenubar(){
				...
				ulElement.innerHTML = `
						<li style="margin-top: 3rem;" ><h1 class="underline__effect">
							<a href="/corporate-resource-centre.php"><i class="fas fa-home"></i>
							Home </h1></a></li>
						<li onclick="showMenuContent(1,this)"><h1 class="underline__effect">
						<i class="fas fa-user"></i>
							About Us</h1></li>
						<li "><h1 class="underline__effect">
						<a href="/tmu/our-recruiters"><i class="fas fa-building"></i>
							Our Recruiters</h1></a></li>
						<li "><h1 class="underline__effect">
						<a href="https://www.tmu.ac.in/tmu/industrial-collaborations"><i class="fas fa-briefcase"></i>
							Industrial Collaborations</h1></a></li>
						<li onclick="showMenuContent(4,this)"><h1 class="underline__effect">
							<i class="far fa-newspaper"></i>
							Testimonials</h1></li>
						<li "><h1 class="underline__effect">
							<a href="https://www.tmu.ac.in/tmu/corporate-resource-centre-contact-us"><i class="fas fa-phone"></i>
							Contact Us</h1></a></li>
					`;
			}
		...
		async function handleMainMenubar(value, listItem) {
			...
			if (h1Element.classList.contains('underline__effect_permanent')) {
				...
				{
					setTimeout(function(){
					h1Element.parentElement.scrollIntoView({behavior: 'smooth'});
					},50);
				}
			}
