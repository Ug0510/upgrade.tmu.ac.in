        ...
        <div class="container-fluid  my-0 px-2">
            <div class="row ps-4">
                <div class="col-md-6 pt-0 pt-md-4 ps-md-5 mb-4">
                    ...
                    <a href="#" class="tmu-btn btn-1 me-4 py-1 px-3 py-xl-2 px-xl-4"> Download Broucher</a>
                ...
                <div class="col-12 col-md-6">
                    <div class="pe-lg-4 position-relative p-0">
                        <div style="z-index: 2;">
                            ...
                            <img src="assets/img/banner/foe/foe-banner.webp" alt="" class="p-0 m-0">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm">
                                                <img src="assets/img/programme_stock_img/ccsit/9.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm">
                                                <img src="assets/img/programme_stock_img/ccsit/30.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm">
                                                <img src="assets/img/programme_stock_img/ccsit/32.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/33.jpg" height="178px" class="card-img-top" alt="...">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/34.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/13.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/25.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/18.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/21.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/3.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                                        ...
                                        <div class="col-md-4">
                                            <!-- Card -->
                                            <div class="card shadow-sm progcard">
                                                <img src="assets/img/programme_stock_img/ccsit/5.jpg" height="178px" class="card-img-top" alt="...">
                                                <div class="card-body progcardbody">
                    ...
                    <div class="container mb-5 mt-5">
                        ...
                        <div class="panel">
                            <ul class="progul">
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/9.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/13.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/16.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/19.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/1.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/34.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/25.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/21.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/3.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/5.jpg" class="card-img-top" alt="...">
                                        <div class="card-body progcardbody">
                        ...
                        <div class="panel">
                            <ul class="progul">
                                <li class="progli">
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/19.jpg" height="178px" class="card-img-top" alt="Engineering image ">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/34.jpg" height="178px">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/13.jpg" height="178px">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/25.jpg" height="178px">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/3.jpg" height="178px">
                                        <div class="card-body progcardbody">
                                ...
                                <li class="progli">
                                    ...
                                    <div class="card shadow-sm progcard">
                                        <img src="assets/img/programme_stock_img/ccsit/5.jpg" height="178px">
                                        <div class="card-body progcardbody">
        ...
        <section>
            <div class="container-xl tmu-testimonial mt-5 mb-3">
                ...
                <div class="owl-carousel owl-carousel-full image-carousel carousel-widget charity-card" style="overflow: visible;" data-stage-padding="20" data-margin="50" data-center="true" data-loop="true" data-nav="true" data-autoplay="200000" data-speed="2000" data-pagi="true" data-items-xs="1" data-items-sm="2" data-items-md="2" data-items-lg="3" data-items-xl="3">
                    ...
                    <div class="oc-item text-start">
                        <div class="media ">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/Akshat_jain1.jpg" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Akshat Jain</b>, B.Tech. (Electrical Engineering)</p>
                                    <p>When I first considered enrolling at Teerthanker Mahaveer University, I was hesitant. But, after meeting the faculty, my doubts dispersed. The professors possess great expertise and are approachable. I have gained a plethora of knowledge from them. Their innovative teaching methods and practical approach have given me invaluable skills. I recommend this college to anyone seeking to build a high-tech career and interested in pursuing engineering.</p>
                                </div>
                            </div>
                    ...
                    <div class="oc-item text-start">
                        <div class="media">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/Tapas_Gupta.webp" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Tapas Gupta</b>, B.Tech. (Electrical Engineering) </p>
                                    <p>I consider myself fortunate to have been a student at Teerthanker Mahaveer University. The university's holistic development approach had a remarkable impact on me. When I first joined the college, I was inexperienced, but the faculty assisted me in honing my professional skills during my four years. I am grateful to have been a part of this community and would like to express my sincere appreciation to TMU.</p>
                                </div>
                                <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                            </div>
                        </div>
                    ...
                    <div class="oc-item text-start">
                        <div class="media">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/Prasan_Jain.webp" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Paras Jain</b>, B.Tech. (Electronics and Communication Engineering)</p>
                                    <p >My entire four-year experience at TMU was exceptional. The faculty and administration possess considerable expertise and are remarkably supportive. My engineering college offers various opportunities. Besides, the hostel is well-maintained, with access to facilities such as the gym, canteen, and sports complexes. I was fortunate enough to secure a placement in a product-based company with an attractive package. I am grateful to the entire TMU family for their unwavering support throughout my placement journey. Thank you for helping me achieve my career goals.</p>
                                    <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="oc-item text-start">
                        <div class="media">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/prafull_sharma_(1).jpg" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Prafull Sharma</b>, B.Tech. (Electronics and Communication Engineering)</p>
                                    <p>I owe my success to my alma mater. The TMU engineering college provided me with the vital skills and opportunities to secure the highest package in my batch. The faculty and management were incredibly supportive, and their guidance pushed me to reach new heights. Working overseas now, I am grateful for the foundation laid by my alma mater. Thank you for shaping me into the professional I am today.</p>
                                </div>
                                <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                            </div>
                        </div>
                    ...
                    <div class="oc-item text-start">
                        <div class="media">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/Anurag_bhatnagar.jpg" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Meghna Bhargava</b>, B.Tech. (Electronics and Communication Engineering)</p>
                                    <p>TMU engineering college was the best decision of my life. The faculty was supportive, and the curriculum was designed that focuses on holistic development. It exposed me to practical training, internships, and workshops that helped me hone my skills. Besides, during my college, I have gained ample amount of real-world experience. Today, as I work in a reputed organisation, I look back at my time in the college with immense pride and gratitude. I am thankful to the management and faculty for their constant guidance and encouragement.</p>
                                </div>
                                <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                            </div>
                        </div>
                    ...
                    <div class="oc-item text-start">
                        <div class="media">
                            <img src="https://www.tmu.ac.in/uploads/alumni_speak/Amrit_aryal.jpg" class="mr-3" alt="">
                            <div class="media-body">
                                <div class="testimonial">
                                    <p class="overview mb-3"><b>Amrit Aryal </b>, B.Tech. (Mechanical Engineering)</p>
                                    <p>My mechanical engineering degree from TMU Engineering College was a game-changer for me. The programme instilled in me the skills and confidence to excel in my career. The faculty members were top-notch, and the practical training I received was invaluable. Thanks to the college’s focus on industry-relevant skills, I was able to hit the ground running when I joined the Nepal Insurance Authority. I’m grateful for the knowledge and opportunities this college provided me and can confidently say that I wouldn’t be where I am today without it.</p>
                                </div>
                                <button class="tmu-btn btn-3 py-2 d-block mx-auto my-0 d-flex align-items-center tmu-fs-14" onclick="showTestimonialModal()">Read More <i class="bi bi-chevron-down ps-2"></i></button>
                            </div>
                        </div>
