...
<section id="content">
    <div class="content-wrap py-0">
        ...
        <!-- Director's Desk Section started -->
        <section>
            <div class="container mb-5">
                <div class="row">
                    <h2 class="tmu-text-primary text-center"><span>From the Desk of </span><span class="d-block d-sm-inline"> Principal</span></h2>
                    <div class="col-md-4 text-center img-container">
                        <img src="./assets/img/foe/foe_principal.webp" class="w-100" alt="">
                    </div>
                    <div class="col-md-8 pt-5">

                        I welcome all new students to the Best Private Engineering College in UP, Faculty of Engineering (FOE) at Teerthanker Mahaveer University Moradabad, India.
                        <br><br>
                        Our aim at the Faculty of Engineering is to educate and create ‘technocrats’ with a solid academic base and the attainment of value-added skills to face local, national and international industrial domains.
                        <br><br>
                        ...
                        <div class="tmu-color mt-4 fw-bold fs-24">Prof. R. K. Dwivedi </div>
                    </div>
                </div>
            </div>
        </section>
