            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-9 col-lg-10 mt-3 mt-sm-0 pt-2 pt-sm-5  ">
                    ...
                    <object data="https://www.tmu.ac.in/pdf/medical/affiliation.pdf" type="application/pdf" width="100%" height="1150px">
		                ...
		                <center><a type="button" class="tmu-btn btn-1 btn-lg btn-rounded text-lg waves-effect waves-light" href="https://www.tmu.ac.in/pdf/medical/affiliation.pdf" download type="https://www.tmu.ac.in/pdf/medical/affiliation.pdf"><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
	                </object>
                </div>
            </div>
        </div>
