...
<section id="content">
    <div class="content-wrap py-0">
        <div class="container-fluid my-0 px-0">
            <div class="row">
                <?php include 'sidebar/engineering_sidebar.php'; ?>
                ...
                <div class="col-12 col-sm-9 col-lg-10 mt-3 mt-sm-0 pt-2 pt-sm-5 ">
                    ...
                    <div class="container">
                        <div class="row mb-4">
                            <object data="https://www.tmu.ac.in/pdf/coe/foe_AC_23_24.pdf" type="application/pdf"
                                ...
                                <center><a type="button"
                                        ...
                                        href="https://www.tmu.ac.in/pdf/coe/foe_AC_23_24.pdf"
                                        download="https://www.tmu.ac.in/pdf/coe/foe_AC_23_24.pdf" data-uw-pdf-br="2"
