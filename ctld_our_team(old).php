        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-3 g-4 mt-5">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    <h5 class="card-title">Ms. Mani Saraswat</h5>
                    <p class="card-text">Senior Trainer - Soft Skills</p>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    <h5 class="card-title">Ms. Anvesha Sisodiya</h5>
                    <p class="card-text">Executive Trainer - Soft Skills</p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    <h5 class="card-title">Mr. Naveen Dubey</h5>
                    <p class="card-text">Executive Trainer - Soft Skills</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="https://www.tmu.ac.in/img/ctld/our_team/Pallav_Pandey.jpg" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
            ...
            <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="https://www.tmu.ac.in/img/ctld/our_team/Praanshi_Jadoun.png" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    <h5 class="card-title">Ms. Praanshi Jadoun</h5>
                    <p class="card-text">Trainer - Soft Skills</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-4 col-xl-4 col-md-6 col-xs-12">
                <div class="card">
                  <img src="https://www.tmu.ac.in/img/ctld/our_team/Shivam_Kashyap.png" class="card-img-top" alt="Image 1">
                  <div class="card-body text-center"> <!-- Added 'text-center' class -->
                    <h5 class="card-title">MR. Shivam Kashyap</h5>
                    <p class="card-text">Trainer - Soft Skills</p>
                </div>
              </div>
            </div>
