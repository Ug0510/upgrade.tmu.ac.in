			<div class="col-md-2 col-lg-2 sticky-sidebar-wrap pe-5 py-0 py-lg-3 " style="background-color: #55555510;">
				...
				<ul class="list-unstyled items-nav sticky-sidebar shop-filter mt-4 d-none d-sm-block" data-container="#shop">
					...
					<li><a href="/nep_fyup_salient.php" data-filter=".sf-nep-fyup-salient">Training Placements
							Cell</a></li>
					<li><a href="/nep_course_list.php" data-filter=".sf-nep-course-lis">Corportae Advisory Board</a>
					</li>
					...
					<li><a href="/nep_fyup_salient.php" data-filter=".sf-nep-fyup-salient">Placements
							News/Articles</a></li>
					<li>
						<hr>
					</li>
					...
					<li><a href="/nep_minor_list.php" data-filter=".sf-nep-minor-list">Anti Ragging Committee</a>
					</li>
					<li>
						<hr>
					</li>
					...
					<li><a href="/nep_minor_list.php" data-filter=".sf-nep-minor-list">Conference Proceedings</a>
					</li>
