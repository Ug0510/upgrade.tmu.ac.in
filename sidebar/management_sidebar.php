...
<div class="col-sm-3 col-lg-2 sticky-sidebar-wrap px-2 pe-sm-5 py-0 py-lg-3 order-last order-sm-first mt-5 mt-sm-0" style="background-color: #55555510;">
	...
	<ul class="list-unstyled items-nav sticky-sidebar shop-filter mt-3" data-container="#shop">
		...
		<li><a href="/mgmt_placement_calendar.php" data-filter=".sf-nep-document">Placement Calednar</a></li>
		<li><a href="/mgmt_placement_brochure.php" data-filter=".sf-nep-minor-list">Placement Brochure</a></li>
		<li><a href="/mgmt_news.php" data-filter=".sf-nep-fyup-salient">Placements
				News/Articles</a></li>
		<li>
			<hr>
		</li>
