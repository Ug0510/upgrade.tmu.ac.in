            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <p>
                            <i class="fa-solid fa-location-dot"></i> &nbsp<b>Location:</b> Opp. Parshvanath Plaza, Delhi
                            Road, Moradabad - 244001 (Uttar Pradesh)<br>
                            <i class="fa-solid fa-envelope"></i> &nbsp<b>Email:</b> principal.management@tmu.ac.in<br>
                            <i class="fa-solid fa-phone"></i> &nbsp<b>Call:</b> (+91) 591-2487111 <br> (+91) 591-2487222
                    ...
                    <div class="col-lg-4 col-sm-6">
                        ...
                        <p>For any query related to TMIMT College of Management, you may drop message or contact the
                ...
                <div class="row gx-lg-0 gy-4 mt-3">
                    ...
                    <div class="col-lg-12">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            <h3 class="text-left mt-1 mb-4" style="color:#001055; "> NEED MORE INFORMATION?</h3>
