						...
						<div class="container mt-3 mb-3">
							<div class="row">
								<object data="https://www.tmu.ac.in/pdf/quality_policy.pdf" type="application/pdf" width="100%" height="1120px">
									...
									<center><a type="button" class="btn btn-success btn-lg btn-rounded text-lg waves-effect waves-light" href="https://www.tmu.ac.in/pdf/quality_policy.pdf" download="https://www.tmu.ac.in/pdf/quality_policy.pdf" data-uw-pdf-br="2" data-uw-pdf-doc=""><i class="fa fa-download fa-2x pr-2" aria-hidden="true"></i>Click here to download PDF file.</a></center>
								</object>
							</div>
						</div>
					</div>
