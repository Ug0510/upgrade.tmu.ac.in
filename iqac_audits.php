        ...
        <div class="col-12 col-md-9 col-lg-9 mt-3 mt-sm-0 pt-5">
          ...
          <div class="row mx-0">
            <h2 class=" text-center" style="color:#001055;
                          text-transform: capitalize;
                          font-weight:700!important; font-size:2.4vmax">Environment & <span
                class="d-block d-sm-inline"> Energy Audits</span></h2>
            <div class="row mx-0">

                <hr class="horizontal-line">

<button class="careers-accordion">Environment & Energy Audits<span
...
<div class="panel">
	...
	<div class="row justify-content-center gutter-30 col-mb-5">
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="	https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/Ginnaur1.jpeg"
						alt="">
				</div>
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/gajgola2.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/aurangabad3.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/Ginnaur2.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/gajgola3.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/manohapur1.jpeg"
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/manohapur2.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/gajgola1.jpeg"
						alt="" style="height: 300px;">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/aurangabad2.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/aurangabad1.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
		...
		<div class="col-sm-4 col-md-4">
			<div class="team card shadow-sm border-0 h-shadow h-translatey-sm all-ts rounded-4 overflow-hidden">
				<div class="team-image">
					<img src="https://www.tmu.ac.in/img/facilities/institutional_values/environment_energy/Ginnaur3.jpeg"
						alt="">
				</div>
				<div class="team-desc p-2">
					<div class="team-title pt-0">
