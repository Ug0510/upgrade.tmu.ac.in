    ...
    <div class="container">
        <div class="page-title-row">
            ...
            <div class="page-title-content">
                <h1 class="text-uppercase">TMU Blogs</h1>
            </div>
						...
						<main class="postcontent col-lg-9">
							...
							<div class="single-post mb-0">
								...
								<div class="entry">
									...
									<!-- Entry Image
									============================================= -->
									<div class="entry-image" style="height: fit-content; background-size: cover; width: 100%; overflow: hidden;">
										<a href="#"><img src="images/MS_blogpost.jpg" alt="Blog Single"></a>
									</div><!-- .entry-image end -->

									<!-- Entry Title
									============================================= -->
									<div class="entry-title">
										<h2>Managing Stress in University Life: Tips for Students to Cope Up.</h2>
									</div><!-- .entry-title end -->
									...
									<div class="entry-meta">
										<ul>
											<li><i class="uil uil-schedule"></i>29 September 2K23</li>
											<li><i class="bi-pencil-square"></i><a href="#">Teerthanker Mahaveer University</a></li>
											<li><i class="bi-grid"></i><a href="#"> Health</a>,<a href="#"> Blogs</a></li>
											<li><i class="uil uil-comments-alt"></i>43 Comments</li>
										</ul>
									</div><!-- .entry-meta end -->
									...
									<div class="entry-content mt-0">
										...
										<p style="text-align: justify;">In today's world, every fragment of our society can be seen engrossed in grappling with the competitive benchmark set by the societal framework. Stress, depression, and various other mental disorders borne from the precincts of this inexorable demon of striving and thriving exert immense pressure on people, especially students. Hence, in such a dire situation, students can commonly feel overwhelmed and experience stress.</p>
										<p style="text-align: justify;">With surging stress levels and enervating anxieties, it becomes all the more crucial to know what might aggravate student stress. Hence, knowing the best possible stress management techniques and taking preventive and prophylactic measure that reduces stress is of vital essence. Let’s delve into knowing more about anomalies like stress and anxiety and what intensifies the sources of stress..</p>
										<h2>What is stress?</h2>
										<p>Often arising from challenging situations, stress is an inherent human response pushing us to address difficulties and potential threats. It's a reality for everyone, though its intensity and impact vary among individuals (quite evidently in students and the younger generation).</p>
										<h2>COMBATING STRESS IN UNIVERSITY LIFE: ALL YOU NEED TO KNOW!</h2>
										<p>Why It's Important: Often, students juggle numerous responsibilities, leading to feeling overwhelmed. Distinguishing between urgent tasks and those that can wait can prevent burnout, improve productivity, and nourish your mental health.</p>
										<p><b>Implementation:</b> List out tasks in order of importance. Break larger tasks into smaller, more achievable components. This approach makes tasks seem less daunting and provides a more precise roadmap for completion.</p>
										...
										<div class="row">
											...
											<div class="col-md-9">
												<div class="d-flex align-items-start mb-2">
													<div>
														<h5 class="text-medium fw-semibold mb-0"><a href="#" class="text-dark">TMU Admin</a></h5>
										...
										<li class="comment even thread-even depth-1" id="li-comment-1">
											...
											<div id="comment-1" class="comment-wrap">
												...
												<div class="comment-content">
													...
													<div class="comment-author">CCSIT<span><a href="#" title="Permalink to this comment">April 24, 2012 at 10:46 am</a></span></div>
												...
												<li class="comment byuser comment-author-_smcl_admin odd alt depth-2" id="li-comment-3">
													...
													<div id="comment-3" class="comment-wrap">
														...
														<div class="comment-content">
															...
															<div class="comment-author">Vineet Saxena<a href='#' rel='external nofollow' class='url'></a><span><a href="#" title="Permalink to this comment">April 25, 2012 at 1:03 am</a></span></div>
										...
										<li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1" id="li-comment-2">
											...
											<div id="comment-2" class="comment-wrap">
												...
												<div class="comment-content">
													...
													<div class="comment-author">Dr. Zareen Farooq<a href='https://themeforest.net/user/semicolonweb' rel='external nofollow' class='url'></a><span><a href="#" title="Permalink to this comment">August 25, 2023 at 1:03 am</a></span></div>
													...
													<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
														...
														<div class="row align-items-center">
															...
															<div class="col-sm-6 d-flex justify-content-sm-end mt-3 mt-sm-0">
																<a href="#" class="social-icon border-transparent border-default si-small h-bg-facebook">
																	<i class="fa-brands fa-facebook"></i>
																	<i class="fa-brands fa-facebook"></i>
																</a>
			
																<a href="#" class="social-icon border-transparent border-default si-small h-bg-instagram">
																	<i class="fa-brands fa-instagram"></i>
																	<i class="fa-brands fa-instagram"></i>
																</a>
			
																<a href="#" class="social-icon border-transparent border-default si-small h-bg-twitter">
																	<i class="fa-brands fa-twitter"></i>
																	<i class="fa-brands fa-twitter"></i>
																</a>
															</div>
											...
											<div class="posts-sm row col-mb-30" id="popular-post-list-sidebar">
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														<div class="col-auto">
															<div class="entry-image" style="height: fit-content;">
																<a href="#"><img class="rounded-circle" src="images/magazine/small/3.jpg" alt="Image"></a>
															</div>
														</div>
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">Bachelor of Pharmacy (B. Pharm) programme: Syllabus, Subjects, Admission, Fees & Colleges</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
												...
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">Bachelor of Technology In Computer Science & Engineering Programme</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
												...
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">What is distance Education</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
											...
											<div class="posts-sm row col-mb-30" id="recent-post-list-sidebar">
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">Master of Business Administration (MBA) Programme</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
												...
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">Excellence Redefined: Teerthanker Mahaveer University among India's Best Private University</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li>10th July 2021</li>
												...
												<div class="entry col-12">
													<div class="grid-inner row g-0">
														...
														<div class="col ps-3">
															<div class="entry-title">
																<h4><a href="#">Role of Toxicology in the Forensic Investigations of Drugs and Poison</a></h4>
															</div>
															<div class="entry-meta">
																<ul>
																	<li>10th July 2021</li>
