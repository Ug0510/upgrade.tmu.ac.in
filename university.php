				...
				<div class="container-fluid p-0">
					<div class="video-banner">
						<video autoplay loop muted playsinline>
							<source src="home-banner-vid3.mp4" type="video/mp4">
			...
			<div class="content-wrap py-0">
				...
				<div class="container d-none d-sm-block">
					...
					<div class="col-xl-12 col-lg-10 text-center">
						<h1 class="h1 fw-bold" style="font-size: 48px; font-weight: 600; line-height: 64px; color:#000000; margin-bottom: 23px;" >Programmes Offered</h1>
					</div>
							...
							<div class="list-group" id="list-tab" role="tablist">
								<a class="pgroup list-group-item listream list-group-item-action rounded-3 shadow-sm active"
									...
									aria-controls="list-home"><i
										class="fa-solid fa-computer fa-sm fakash"></i>&nbsp;Computer Science
								...
								<div class="tab-pane fade" id="list-messages" role="tabpanel"
									...
									<div class="row">
										...
										<div class="col-md-4">
											<!-- Card -->
											<div class="card shadow-sm">
												<img src="https://d1vwxdpzbgdqj.cloudfront.net/s3-public-images/Corporates/esdst-dba.png"
													height="178px">
												<div class="card-body progcardbody">
													<span height="178px"
														class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>
				...
				<div class="col-xl-12 col-lg-10 text-center">
					<h1 class="h1 fw-bold" style="font-size: 30px; font-weight: 600; line-height: 40px; color:#000000; margin-bottom: 19px;" >Programmes Offered</h1>
				</div>
						...
						<div class="accordion-item">
							<h2 class="accordion-header" id="panelsStayOpen-headingThree">
								<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
									...
									<i
										class="fa-solid fa-business-time fa-sm fakash"></i>&nbsp;&nbsp;Management</button>
							</h2>
