                ...
                <div class="col-md-9">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img src="images/infra/2-01.webp" alt="Slide 6"></div>
                            <div class="swiper-slide"><img src="images/infra/3-01.webp" alt="Slide 8"></div>
                            <div class="swiper-slide"><img src="images/infra/4-01.webp" alt="Slide 9"></div>
                            <div class="swiper-slide"><img src="images/infra/5-01.webp" alt="Slide 10"></div>
                            <div class="swiper-slide"><img src="images/infra/6-01.webp" alt="Slide 11"></div>
                            <div class="swiper-slide"><img src="images/infra/7-01.webp" alt="Slide 12"></div>
                            <div class="swiper-slide"><img src="images/infra/8-01.webp" alt="Slide 13"></div>
                            <div class="swiper-slide"><img src="images/infra/9-01.webp" alt="Slide 14"></div>
                            <div class="swiper-slide"><img src="images/infra/10-01.webp" alt="Slide 15"></div>
                            <div class="swiper-slide"><img src="images/infra/11.webp" alt="Slide 16"></div>
                            <div class="swiper-slide"><img src="images/infra/12.webp" alt="Slide 17"></div>
                            <div class="swiper-slide"><img src="images/infra/13-01.webp" alt="Slide 18"></div>
                            <div class="swiper-slide"><img src="images/infra/14-01.webp" alt="Slide 19"></div>
            ...
            <div class="row ">
                <div class="col-md-3">
                    <div class="list-group" id="list-tab" role="tablist">
                        <h4 class="mb-0"><a class="list-group-item listream list-group-item-action rounded-3 shadow-sm active" id="list-settings-list" data-bs-toggle="list" href="#list-settings" role="tab" aria-controls="list-settings"><i class="fa-solid fa-scale-unbalanced fa-sm fakash"></i>&nbsp;Law
                                <span class="badge rounded-pill">03</span></a></h4>
                        <h4 class="mb-0"><a class="pgroup list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2" id="list-home-list" data-bs-toggle="list" href="#list-home" role="tab" aria-controls="list-home"><i class="fa-solid fa-computer fa-sm fakash"></i>&nbsp;Computer
                                Science &nbsp;&nbsp;<span class="badge rounded-pill">14</span></a></h4>
                        <h4 class="mb-0"><a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2" id="list-profile-list" data-bs-toggle="list" href="#list-profile" role="tab" aria-controls="list-profile"><i class="fa-solid fa-microchip fa-sm fakash"></i>&nbsp;Engineering
                                &nbsp;&nbsp;<span class="badge rounded-pill">10</span></a></h4>
                        <h4 class="mb-0"><a class="list-group-item listream list-group-item-action rounded-3 shadow-sm mt-2" id="list-messages-list" data-bs-toggle="list" href="#list-messages" role="tab" aria-controls="list-messages"><i class="fa-solid fa-business-time fa-sm fakash"></i>&nbsp;Management
                                &nbsp;&nbsp;<span class="badge rounded-pill">12</span></a></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow-sm ">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5>Btech Computer Science & Engineering</h5>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5>Mtech Artificial Intelligence & Machine Learning
                                            </h5>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                            <!--<span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>-->
                                            <h5>BCA Information Security & Cyber Security</h5>
                                        </div>
                                        <div class="card-footer d-flex justify-content-between align-items-center bg-white py-3">
                                            <div>
                                            </div>
        ...
        <div class="container" style="margin-bottom: 10px;">
            ...
            <div class="row col-mb-37">
                <main class="postcontent col-lg-8 col-md-9">
                    ...
                    <div class="row g-4 mb-0 d-none d-sm-block shadow">
            ...
            <div class="item">
                <div class="card shadow-sm ">
                    ...
                    <div class="card-body">
                        ...
                        <center><img src="assets/img/icons/arrow2.svg" style="width: 20%;" style="width: 20%;" alt="" class="img-fluid career-tran__arrow"></center>
            ...
            <div class="item">
                ...
                <div class="card shadow-sm ">
                    ...
                    <div class="card-body">
                        <!--<span class="badge bg-info1 text-light mb-2 fw-normal px-2 py-1">New</span>-->
                        <h4 style="text-align:center;" class="mb-2">Btech Computer Science (Data Science)</h4>
                        <center><img src="assets/img/icons/arrow2.svg" style="width: 20%;" alt="" class="img-fluid career-tran__arrow"></center>
                        <p class="career-tran__prev-role">Senior Technical Account Manager</p>
                        <p class="career-tran__prev-comp">Amazon Web Services (AWS)</p>
                        <p class="mb-4 op-07" style="line-height: 1.65"></p>
