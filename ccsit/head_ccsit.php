	...
	<div id="wrapper">
		...
		<header>
			<nav id="main--menubar">
				...
				<div class="left-section">
					...
					<div class="container mobile-inner-nav d-block d-xl-none">
				...
				<div class="right-section">
					...
					<nav class="navbar navbar-expand-lg navbar-dark navbar-custom d-none d-xl-block">
		...
		<script>
			...
			function closeMenubar() {
				...
				const ulElement = document.querySelector('.university-nav');
